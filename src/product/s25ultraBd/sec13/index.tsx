            ...
            <div className='pic_wrap'>
              ...
              <div className='img_wrap chip_wrap'>
                <picture>
                  <source
                    media='(max-width: 750px)'
                    srcSet={src + "/images/bd/sec13_16g_mb.webp"}
                  />
                  <source
                    media='(min-width: 751px)'
                    srcSet={src + "/images/bd/sec13_16g_pc.webp"}
                  />
                  <img
                    loading='lazy'
                    src={src + "/images/bd/sec13_16g_pc.webp"}
                  />
                </picture>
              </div>
            </div>
            ...
            <div className='pic_wrap'>
              <div className='img_wrap phone_wrap'>
                <picture>
                  ...
                  <source
                    media='(min-width: 751px)'
                    srcSet={src + "/images/bd/sec13_part2_pc.webp"}
                  />
                  <img
                    loading='lazy'
                    src={src + "/images/bd/sec13_part2_pc.webp"}
                  />
                </picture>
              </div>
              <div className='img_wrap light_wrap'>
