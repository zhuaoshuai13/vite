...
window.pop8Config = {
  ...
  sec5: {
    ...
    d1: `Welcome aboard TECNO's ingenious Dynamic Port,<br /> seamlessly integrated into the screen display. Intuitive UI<br /> brings efficient notifications - Stay in the know without<br /> frequent unlocking, checking, or app switching. Traditional<br /> mode is also available for your flexibility.<br /> Experience simplified, but not compromised!`,
  },
  sec6: {
    text: "Image",
    ...
    d1: "Dusk to dawn, in or out, selfie master on the front is always<br /> here to deliver! 8MP camera for sharp clarity, with light-sensitive<br /> pixel, dual flash ,and screen fill light for your radiant glow. Plus<br /> battle-tested beauty enhancements for every skin tone!<br /> Step into the spotlight and let your inner star be doubly shine.",
    param1t: "Super Night",
    param1d: "Algorithm",
    param2t: "8MP",
  ...
  sec7: {
    ...
    d1: "Super-Wide aperture + Super-Large pixel unit. <br/> Let the SUPER DUO on the back supercharge your portraits in all lighting.<br /> Undimmed even in the backlight! HDR merges frames for clarity to outshine,<br /> while background blur crafts a stage for you to star. <br/> Capture beauty, whenever, wherever.",
    param1t: "13MP",
    param1d: "Ultra Clear",
    param2t: "HDR Effect",
  ...
  sec12: {
    ...
    desc: `Say goodbye to power anxiety with a mega,<br /> marathon battery! Dive into non-stop videos<br /> and music. The versatile Type-C port plays<br /> along – up or down, plug it in any way you<br /> want. A feature usually reserved for pricier<br /> models - level up your experience, level down<br /> your costs!`,
    p1a: `5000mAh`,
    p1b: `Large Battery`,
    p2a: `10W`,
    p2b: `Charge`,
  ...
  sec13: {
    ...
    desc: `Leading the range with leading-edge side-mounted fingerprint<br /> sensor. Unlock intuitively, and elegantly. No lifting or fumbling.<br /> A gentle touch with fingertip - Voila, your device is ready at<br /> your service.`,
