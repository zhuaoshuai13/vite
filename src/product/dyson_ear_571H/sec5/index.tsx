...
const Sec5 = () => {
  const colorList = [
    {
      ...
      colors: [
        ...
        },
        {
          ...
          name: "锋芒银2",
          timage:
            "https://wwwuat-img.dyson.cn/wysiwyg/ColurPicker/choose_CNC_Aluminium.jpg",
        },
      ],
    },
    {
  ...
  const [selectColor, setSelectColor] = useState<ColorItem[]>(
    colorList.map((item) => item.colors[0])
  )
  ...
  useEffect(() => {
    ...
    $(".colour_picker_part_color_wrapper").on("click", function () {
      ...
      currentColorItemSelector = $(this).find(".colour_picker_part_color_item")
      ...
      const currentColorGroupSelector = $(this).parents(".colour_picker_group")
    ...
    $(
      ".colour_picker_part_item:last-child .colour_picker_part_color_wrapper:nth-child(1"
    ).click()
    console.log(
      $(
        ".colour_picker_part_item:last-child .colour_picker_part_color_wrapper:nth-child(1"
    ...
    <section className='sec5' ref={wrap}>
      <div className='sec5_wrap'>
        <div
          ...
          data-part1-image='https://wwwuat-img.dyson.cn/wysiwyg/ColurPicker/stephen_head.jpg'
          data-part2-image='https://wwwuat-img.dyson.cn/wysiwyg/ColurPicker/stephen_ear.jpg'
          data-composite-image='https://wwwuat-img.dyson.cn/wysiwyg/ColurPicker/default.jpg'
          data-widget-group='Picker1'
        >
          <div className='container'>
            ...
            <div className='left'>
              <div className='left-one composite' video-url={"video"}>
                <img
                  className='composite-image'
                  // src={["selected_composite"]["image"]}
                />
                ...
                <div
                  className={`play-btn-wrapper ${
                    ["selected_composite"]["video"] ? "video-hidden " : ""
                  }`}
                >
              ...
              <div className='left-two'>
                <div className='middle-top'>
                  <img
                    ...
                    // src={["selected_part_image"]["part1_image"]}
                    alt=''
                  />
                </div>
                <div className='middle-bottom'>
                  <img
                    ...
                    // src={["selected_part_image"]["part2_image"]}
                    alt=''
                  />
                </div>
              </div>
            ...
            <div className='right'>
              <div className='title'>声来多彩，由你掌控</div>
              <div className='description'>定制你的独家耳机色彩组合</div>
                ...
                {colorList.map((item, index) => (
                  ...
                  >
                    ...
                    <ul
                      ...
                      data-part-number={index + 1}
                    >
                      {item.colors.map((colorItem, colorIndex: number) => (
                        <li
                        ...
                        >
                          <div
                            className={`colour_picker_part_color_item_border ${
                              colorItem.id == selectColor[index]?.id
                                ? "selected"
                                : ""
                            }`}
                          >
