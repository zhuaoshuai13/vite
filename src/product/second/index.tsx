...
const Product = () => {
  ...
  const { open, setOpen, ...restFunc } = Pc(total, can1)
  // 监听页面宽度
  ...
  return (
    <div className='pova5Pro' ref={total}>
      ...
      <div className='section sec8'>
        ...
        <canvas width='1920' height='1080' ref={can1}></canvas>
      </div>
      ...
      <div className='section sec24'>
        ...
        <div className='params'>
          ...
          <div className='box2'>
            ...
            <div className='param'>
              <div className='big bigtext'>25%</div>
              <div
                className='small'
                dangerouslySetInnerHTML={{
            ...
            <div className='param'>
              <div className='big bigtext'>30%</div>
              <div
                className='small'
                dangerouslySetInnerHTML={{
            ...
            <div className='param'>
              <div className='big bigtext'>50%</div>
              <div
                className='small'
                dangerouslySetInnerHTML={{
