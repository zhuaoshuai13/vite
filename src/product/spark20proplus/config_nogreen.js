...
window.spark20proplusConfig = {
  ...
  sec1: {
    ...
    type2: {
      kv_pc: url + "/images/sec1KvPc_nogreen.png",
      kv_mb: url + "/images/sec1KvMb_nogreen.png",
    },
  },
  sec2: {
  ...
  sec7: {
    ...
    phone: {
      img_pc: url + "/images/sec7PcPhone_white.png",
      img_mb: url + "/images/sec7PcPhone_white.png",
    },
  },
  sec8: {
    double_curved: {
