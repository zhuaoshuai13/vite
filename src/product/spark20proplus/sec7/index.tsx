    ...
    <section className='sec7'>
      <div className='content'>
        <h3 className='title_96 pc'>
          {spark20proplusConfig.sec7.bigTitle.map(
        ...
        <h3 className='title_96 mob'>
          {spark20proplusConfig.sec7.bigTitleMb.map(
            (item: string, index: number) => {
              return (
                <p key={index}>
                  <span dangerouslySetInnerHTML={{ __html: item }}></span>
        ...
        <div className='spark20_container'>
            ...
            <div className='text_wrapper'>
              <h4
                ...
                dangerouslySetInnerHTML={{
                  __html: spark20proplusConfig.sec7.design.title,
                }}
              ></h4>
              <p
                className='subtitle_24'
                dangerouslySetInnerHTML={{
                  __html: spark20proplusConfig.sec7.design.subtitle,
                }}
              ></p>
              <p
                className='desc_18'
                dangerouslySetInnerHTML={{
                  __html: spark20proplusConfig.sec7.design.desc,
                }}
              ></p>
            </div>
            {/* <div className='datas'>
          ...
          <picture>
            ...
            <source media='(max-width: 1080px)' srcSet={spark20proplusConfig.sec7.phone.img_mb} />
            <img
              src={spark20proplusConfig.sec7.phone.img_pc}
              alt='Quadrant Star Array'
