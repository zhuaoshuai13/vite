...
const FirstProduct = () => {
  ...
  // return responsive?.md == undefined ? (
  //   <></>
  // ) : (
  //   <>
  //     <div ref={total}>
  ...
  //               Boldly engage in battles with the 7000mAh battery, which
  //               provides powerful backup for uninterrupted gaming sessions.
  //               Combined with the added benefit of 18W Flash Charge, say goodbye
  //               to power shortages from now on.
  //             </div>
  ...
  //             <div className='desc textAni Hfont'>
  //               The STS coating technology ensures safety by preventing
  //               dangerous internal short circuits caused by direct contact
  //               between aluminum foil and anode, providing you with complete
  //               peace of mind.
  //             </div>
  //           </div>
  //         </div>
  ...
  //               The MediaTek Helio G85 boosts the Arm Mali-G52 GPU to 1.0 GHz
  //               for seamless and efficient mobile gaming on-the-go.
  //             </div>
  //             <div className='f2'></div>
  //           </div>
  ...
  //                   <br />• Application startup speed increased by 45% on
  //                   average
  //                 </div>
  //                 <div className='desc2'>
  ...
  //         <div className='desc textAni Hfont'>
  //           Get the most out of your gaming experience with an enhanced
  //           experience that features smoother graphics, richer detail, and total
  //           immersion.
  //         </div>
  //         <div className='img textAni'></div>
  //       </section>
  ...
  //         <div className='img textAni'></div>
  //         <div className='desc textAni Hfont'>
  //           Treat your eyes to a tapestry of color and beauty. <br /> A series
  //           of interconnected wallpapers merge objects and creatures from the
  //           real world and the imagination. Your <br className='pc' /> life is
  ...
  //             lightning-fast speed to launch top 10 large-scale games in
  //             seconds. Foreground launch rate up by 85%, enjoy seamless gameplay
  //             with no wait. Common App launch rate up by 95%, gain instant
  //             access and maximum efficiency.
  //           </div>
  //         </div>
  //         <div className='movie'>
      ...
      <section className='section sec8'>
        ...
        >
          <SwiperSlide>
            <div className='box box2'>
              <div className='right'>
                ...
                <div className='desc textAni Hfont'>
                  Boldly engage in battles with the 7000mAh battery, which
                  provides powerful backup for uninterrupted gaming sessions.
                  Combined with the added benefit of 18W Flash Charge, say
                  goodbye to power shortages from now on.
                </div>
                <div className='params textAni'>
                  <div className='param Hfont'>
                    <div className='big'>18H+</div>
            ...
            <div className='movie movie2'></div>
          </SwiperSlide>
          <SwiperSlide>
            <div className='box box1'>
              <div className='right'>
            ...
            <div className='movie movie1'></div>
          </SwiperSlide>
        </Swiper>
