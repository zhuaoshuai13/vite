        ...
        <div className='spark20_container'>
          ...
          <div className='right1'>
            <div className='text_wrapper'>
              ...
              <p className='desc_18'>
                Find your Mr. Right among SPARK's trendy color options: <br />
                <span>Cyber White:</span> Dance in the tender interplay of light
                and shadow <br />
                <span>Gravity Black:</span> Exude timeless elegance of classic
                values <br />
                <span>Neon Gold:</span> Radiate nobility as sand glitters in
                starry brilliance <br />
                <span>Magic Skin 2.0:</span> Beauty meets durability. 500% more
                durable. 25% more UV protection. Glossy matte leather feels like
                the touch of luxurious yacht.
              </p>
            </div>
            ...
            <div className='data_all'>
              ...
              <div className='datas'>
                <div className='data'>
                  <div className='data_title'>Glossy Matte <br /> Leather</div>
                  <p className='data_desc'>Visual Upgrading</p>
                </div>
                <div className='data'>
                  <div className='data_title'>100% <br /> Recyclable</div>
                  <p className='data_desc'>Eco-friendy</p>
                </div>
                <div className='data'>
                  <div className='data_title'>Zero</div>
                  <p className='data_desc'>Harmful <br /> Substance</p>
                </div>
                <div className='data'>
